...
namespace Semana05
{
    ...
    public partial class ListaCategoria : Window
    {
        ...
        private void btnConsultarActivo_Click(object sender, RoutedEventArgs e)
        {
            CargarActivo();
        }
        ...
        private void CargarActivo()
        {
            ...
            {
                Bproducto = new BProducto();
                dgvCategoria.ItemsSource = Bproducto.ListarActivo(true);
            }
            catch (Exception ex)
            {
                MessageBox.Show("Comunicarse con el Administrador");
        ...
        private void btnConsultarInactivo_Click(object sender, RoutedEventArgs e)
        {
            CargarInactivo();
        }
        ...
        private void CargarInactivo()
        {
            ...
            {
                Bproducto = new BProducto();
                dgvCategoria.ItemsSource = Bproducto.ListarInactivo(false);
            }
            catch (Exception ex)
            {
                MessageBox.Show("Comunicarse con el Administrador");
